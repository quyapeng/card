...
export function validatorPassword(rule: any, value: string, callback: any) {
...
export function validatorPasswordAgain(this: any, rrule: any, value: string, callback: any) {
...
export function validatorPhone(rule: any, value: string, callback: any) {
  if (value === '') {
...
export function validatorMail(rule: any, value: string, callback: any) {
  if (value === '') {
    callback()
...
// 短信验证码
export function validateSmsCode(rule: any, value: string, callback: any) {
...
export function validateBankName(rule: any, value: string, callback: any) {
  if (value.length > 50) {
...
export function validatePersonName(rule: any, value: string, callback: any) {
